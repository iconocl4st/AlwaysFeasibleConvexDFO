...
'''
cd '/media/thallock/My Book Duo1/linux_partition/oldwork/oldhome/thallock/Documents/PycharmProjects/ReWrite'
cd '/media/thallock/My Book Duo1/from_work/to_evacuate/research/line-search-dfo'
'''
